      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "How to Install MCP Servers in Cursor (Step-by-Step Guide)", item: "https://bestmcpservers.com/guides/how-to-install-mcp-servers-in-cursor/" },
          ],
        }) }}
      />
      {/* Header */}
