...
const template = prdTemplates.find((item) => item.slug === "mcp-server-prd-template")!;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${baseUrl}/mcp-server-prd-template/` },
  openGraph: {
    title: template.title,
    description: template.description,
    type: "article",
    url: `${baseUrl}/mcp-server-prd-template/`,
  },
  twitter: {
