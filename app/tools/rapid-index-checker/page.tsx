...
import RapidIndexCheckerTool from "./RapidIndexCheckerTool";

const tool = getTool("rapid-index-checker");
...
const relatedLinks = [
  ...
  { href: "/guides/ai-search-visibility-checker/", label: "AI Search Visibility Guide" },
...
const featureList = [
  "Single URL public-signal verdicts for indexing risk",
  "Bulk URL triage with CSV upload and audit buckets",
  "Reason-first outputs for canonicals, robots, sitemap, and crawl support",
  "Browser-only workflow with no backend or account requirement",
];
        ...
        <div className="mx-auto max-w-7xl px-4 py-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex gap-6">
              ...
              <Link href="/workflows/" className="text-sm text-slate-600 hover:text-slate-900">
                Workflows
              </Link>
              <Link href="/tools/" className="text-sm font-semibold text-blue-600">
                Tools
              </Link>
            </nav>
          </div>
