...
const relatedLinks = [{ href: "/ai-prd-generator/", label: "AI PRD Generator" }, { href: "/agents/", label: "AI Agent Library" }, { href: "/guides/best-mcp-servers-for-claude/", label: "Best MCP Servers for Claude" }, { href: "/guides/how-to-install-mcp-servers-in-cursor/", label: "Install MCP Servers in Cursor" }, { href: "/tools/ai-cost-calculator/", label: "AI Cost Calculator" }];
