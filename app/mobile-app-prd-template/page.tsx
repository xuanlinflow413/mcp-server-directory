...
const template = prdTemplates.find((item) => item.slug === "mobile-app-prd-template")!;
...
export const metadata: Metadata = {
  ...
  alternates: { canonical: `${baseUrl}/mobile-app-prd-template/` },
  openGraph: {
    title: template.title,
    description: template.description,
    type: "article",
    url: `${baseUrl}/mobile-app-prd-template/`,
  },
  twitter: {
