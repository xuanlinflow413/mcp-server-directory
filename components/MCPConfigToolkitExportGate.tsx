    ...
    <div className="mt-8 grid gap-6 lg:grid-cols-[0.9fr_1.1fr]">
      <div className="rounded-2xl border border-blue-200 bg-blue-50 p-6">
        ...
        <p className="mt-4 text-sm leading-6 text-slate-700">
          The free generators create planning templates. Builder Pack and Pro unlock a production bundle for real rollouts with deployment-ready setup guidance and safety checks.
        </p>
...
export default function MCPConfigToolkitExportGate() {
  ...
  useEffect(() => {
    ...
    if (!token) {
      setStatus("locked");
      setMessage("Sign in and unlock Builder Pack or Pro to view the production toolkit.");
      return;
    }
