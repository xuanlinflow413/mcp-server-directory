...
export const aiCodingTools: AiCodingTool[] = [
  ...
  },
  {
    slug: "gemini-cli",
    name: "Gemini CLI",
    tagline: "Terminal AI agent for Google model workflows and large-context coding",
    description:
    ...
    bestFor: "Developers who want a CLI coding assistant with strong long-context reasoning and Google ecosystem model access.",
    pricing: "Depends on Google AI plan, API usage, and product access",
    rating: 4.2,
    website: "https://ai.google.dev/gemini-api/docs/cli",
    categories: ["Terminal Agent", "Google AI", "Large Context"],
    strengths: ["CLI-native workflow", "Good long-context fit", "Useful for research-heavy code tasks", "Pairs well with Google AI tooling"],
    limitations: ["Requires terminal setup", "Feature surface can change quickly", "Needs explicit verification for code changes"],
    workflowFit: ["Large-context repo research", "CLI-assisted implementation", "Debugging", "Spec-to-code planning"],
    ideSupport: "Terminal-first; works alongside any editor",
    modelSupport: "Google Gemini model access depending on configured account and API settings",
    repoContext: "Can inspect local files and command output when run inside a repository workflow",
    agentMode: "CLI assistant and agent-style loop depending on configuration and permissions",
    privacy: "Review Google account, API, logging, and repository access settings before private-code usage",
    mcpSupport: "Useful with MCP-backed docs, GitHub, filesystem, browser, and deployment evidence workflows",
    mcpAngle: "Gemini CLI fits teams that want MCP-style context routing around a terminal agent, especially for large-context code research and implementation planning.",
  },
  {
    slug: "qwen-code",
    name: "Qwen Code",
    tagline: "Open coding-agent workflow built around Qwen model access",
    description:
    ...
    bestFor: "Builders evaluating Qwen-backed coding agents, multilingual code assistance, and lower-cost model routing for developer workflows.",
    pricing: "Open tooling and model/API costs depend on chosen Qwen deployment or provider",
    rating: 4.1,
    website: "https://github.com/QwenLM",
    categories: ["Coding Agent", "Open Model", "Terminal Workflow"],
    strengths: ["Open-model ecosystem", "Good experimentation fit", "Can support multilingual teams", "Potential cost flexibility"],
    limitations: ["Requires setup choices", "Model quality depends on deployment", "Enterprise controls depend on hosting path"],
    workflowFit: ["Model experimentation", "CLI coding", "Multilingual development", "Cost-aware coding agents"],
    ideSupport: "Terminal and integration-dependent workflows rather than one fixed IDE",
    modelSupport: "Qwen model family through local, hosted, or provider-specific access",
    repoContext: "Depends on the agent wrapper and local repository permissions used with Qwen models",
    agentMode: "Agentic behavior depends on selected client, tools, and execution sandbox",
    privacy: "Self-hosting can increase control, but hosted providers require data and logging review",
    mcpSupport: "Strong fit for MCP-style tool boundaries when using open models with filesystem, GitHub, and docs context",
    mcpAngle: "Qwen Code is relevant to teams comparing commercial AI coding tools with open-model agent stacks governed by MCP-style permissions.",
  },
  {
    slug: "roo-code",
    name: "Roo Code",
    tagline: "Open-source VS Code agent for structured coding modes",
    description:
    ...
    bestFor: "VS Code users who want an open-source agent with mode-based workflows and explicit control over model providers and tool actions.",
    pricing: "Open source; model/API costs depend on provider",
    rating: 4.3,
    website: "https://github.com/RooCodeInc/Roo-Code",
    categories: ["Open Source", "VS Code", "Tool Use"],
    strengths: ["Open-source VS Code workflow", "Multiple modes", "Provider flexibility", "Explicit tool control"],
    limitations: ["Requires configuration", "Quality varies by selected model", "Long tasks still need review and tests"],
    workflowFit: ["VS Code agent work", "Mode-based implementation", "Local debugging", "Open-source coding workflows"],
    ideSupport: "VS Code extension",
    modelSupport: "Multiple model providers depending on configuration",
    repoContext: "Works inside a local VS Code workspace with file, terminal, and project context",
    agentMode: "Agentic tool use with configurable modes for code, architecting, debugging, and review",
    privacy: "Client is open source, but data handling depends on the selected provider and local permissions",
    mcpSupport: "Good fit for MCP because permissions, tools, and provider routing are central to the workflow",
    mcpAngle: "Roo Code is most useful when MCP-style rules define which files, commands, browser actions, and external systems the VS Code agent can touch.",
  },
  {
    slug: "sourcegraph-cody",
    name: "Sourcegraph Cody",
    tagline: "Codebase-aware AI assistant for enterprise repositories",
    description:
    ...
    bestFor: "Teams with large repositories or many services that need code search, code intelligence, and AI assistance across an existing engineering platform.",
    pricing: "Free and paid Sourcegraph plans depending on user count, deployment, and enterprise features",
    rating: 4.2,
    website: "https://sourcegraph.com/cody",
    categories: ["Codebase Chat", "Enterprise Search", "IDE Extension"],
    strengths: ["Strong large-codebase context", "Sourcegraph search integration", "Enterprise deployment options", "Works across existing repos"],
    limitations: ["Best value requires Sourcegraph context", "Less autonomous than dedicated coding agents", "Setup depth depends on repository scale"],
    workflowFit: ["Large codebase Q&A", "Repo onboarding", "Cross-repo search", "Enterprise code assistance"],
    ideSupport: "VS Code, JetBrains, and Sourcegraph surfaces depending on setup",
    modelSupport: "Provider and model options depend on Sourcegraph plan and deployment",
    repoContext: "Strong code search and code intelligence context across connected repositories",
    agentMode: "Assistant and edit workflow rather than high-autonomy task delegation",
    privacy: "Enterprise deployment and access controls should be reviewed for private repositories",
    mcpSupport: "Pairs with docs, GitHub, and internal knowledge MCP workflows for large-codebase onboarding",
    mcpAngle: "Cody is strongest when MCP-backed workflows add issue, docs, and deployment evidence to Sourcegraph's codebase understanding.",
  },
  {
    slug: "tabnine",
    name: "Tabnine",
    tagline: "Enterprise AI code completion with privacy controls",
    description:
    ...
    bestFor: "Organizations that prioritize privacy controls, approved IDE plugins, and safer rollout of AI coding assistance across larger engineering teams.",
    pricing: "Free and paid Pro, Enterprise, or custom deployment plans depending on packaging",
    rating: 4.1,
    website: "https://www.tabnine.com",
    categories: ["Code Completion", "Enterprise", "IDE Extension"],
    strengths: ["Enterprise privacy positioning", "Broad IDE support", "Lower-friction adoption", "Good autocomplete workflow"],
    limitations: ["Less agentic than terminal agents", "Limited autonomous execution", "May need another tool for PR-level delegation"],
    workflowFit: ["Autocomplete", "Enterprise rollout", "Everyday coding", "Privacy-sensitive teams"],
    ideSupport: "VS Code, JetBrains, Visual Studio, Eclipse, and other IDE integrations depending on current support",
    modelSupport: "Tabnine-managed and deployment-dependent AI model options",
    repoContext: "Context depends on IDE, workspace, and enterprise configuration",
    agentMode: "Primarily assistant and completion workflow rather than autonomous coding agent",
    privacy: "Privacy and deployment controls are a core buying criterion; review plan-specific settings",
    mcpSupport: "Best paired with MCP-governed review, docs, and security workflows when teams need more than autocomplete",
    mcpAngle: "Tabnine can serve as a low-friction AI coding layer while MCP-backed workflows cover repository evidence, docs, and stricter agent permissions.",
  },
];
...
export const aiCodingComparisons: AiCodingComparison[] = [
  ...
  },
  {
    ...
    title: "Gemini CLI vs Claude Code",
    description: "Compare two terminal-first AI coding workflows for large-context repo research, implementation, command output, tests, and verification evidence.",
    tools: ["gemini-cli", "claude-code"],
    verdict: "Choose Gemini CLI when Google model access and large-context research are the main buying criteria. Choose Claude Code when the workflow depends on mature terminal implementation loops, tests, and evidence-backed reporting.",
  },
  {
    slug: "roo-code-vs-cline",
    title: "Roo Code vs Cline",
    description: "Compare two open-source VS Code coding agents for tool approvals, provider flexibility, mode-based workflows, terminal actions, and MCP-ready permissions.",
    tools: ["roo-code", "cline"],
    verdict: "Choose Roo Code when mode-based VS Code workflows and provider flexibility matter. Choose Cline when you want a widely recognized open-source VS Code agent with explicit tool approval and browser or terminal actions.",
  },
  {
    slug: "qwen-code-vs-aider",
    title: "Qwen Code vs Aider",
    description: "Compare a Qwen-backed coding-agent workflow with a lightweight open-source terminal pair programmer for local repos, provider control, cost, and verification.",
    tools: ["qwen-code", "aider"],
    verdict: "Choose Qwen Code when open-model experimentation, multilingual workflows, and cost-aware routing matter. Choose Aider when you want a stable terminal pair-programming workflow with git-visible edits and broad provider support.",
  },
  {
    slug: "sourcegraph-cody-vs-cursor",
    title: "Sourcegraph Cody vs Cursor",
    description: "Compare codebase-aware enterprise assistance with an AI-native IDE for large repositories, cross-repo search, feature work, and team rollout.",
    tools: ["sourcegraph-cody", "cursor"],
    verdict: "Choose Sourcegraph Cody when large-codebase search and enterprise repository context are the bottleneck. Choose Cursor when the team can switch to an AI-native editor for day-to-day feature work and multi-file agent edits.",
  },
  {
    slug: "tabnine-vs-github-copilot",
    title: "Tabnine vs GitHub Copilot",
    description: "Compare privacy-focused enterprise code completion with GitHub-native AI coding assistance for IDE rollout, autocomplete, chat, and team governance.",
    tools: ["tabnine", "github-copilot"],
    verdict: "Choose Tabnine when privacy controls and approved enterprise deployment paths matter most. Choose GitHub Copilot when GitHub-native workflows, broad adoption, and PR-adjacent assistance are the main priorities.",
  },
];
